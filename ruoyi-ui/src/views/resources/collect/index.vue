<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="收藏夹名" prop="cName">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['resources:collect:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['resources:collect:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['resources:collect:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['resources:collect:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="collectList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="收藏夹名" align="center" prop="cName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="收藏夹名" prop="cName">
          <el-input v-model="form.cName" placeholder="请输入收藏夹名" />
        </el-form-item>
      </el-form>
...
<script>
import { listCollect, getCollect, delCollect, addCollect, updateCollect } from "@/api/resources/collect";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('resources/collect/export', {
        ...this.queryParams
