<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="电话" prop="aPhonenumber">
        <el-input
          v-model="queryParams.aPhonenumber"
          placeholder="请输入电话"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['users:address:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['users:address:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="addressList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="电话" align="center" prop="aPhonenumber" />
      <el-table-column label="地址" align="center" prop="aAddress" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="姓名" prop="aName">
          <el-input v-model="form.aName" placeholder="请输入姓名" />
        </el-form-item>
        <el-form-item label="电话" prop="aPhonenumber">
          <el-input v-model="form.aPhonenumber" placeholder="请输入电话" />
        </el-form-item>
        <el-form-item label="地址" prop="aAddress">
          <el-input v-model="form.aAddress" type="textarea" placeholder="请输入内容" />
        </el-form-item>
      </el-form>
...
<script>
import { listAddress, getAddress, delAddress, addAddress, updateAddress } from "@/api/users/address";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('users/address/export', {
        ...this.queryParams
