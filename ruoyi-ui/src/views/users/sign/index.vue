<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="连续签到天数" prop="continueDays">
        <el-input
          v-model="queryParams.continueDays"
    ...
    <el-table v-loading="loading" :data="signList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="连续签到天数" align="center" prop="continueDays" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="连续签到天数" prop="continueDays">
          <el-input v-model="form.continueDays" placeholder="请输入连续签到天数" />
        </el-form-item>
      </el-form>
...
<script>
import { listSign, getSign, delSign, addSign, updateSign } from "@/api/users/sign";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('users/sign/export', {
        ...this.queryParams
