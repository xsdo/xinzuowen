<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="教师班级id" prop="teacherId">
        <el-input
          v-model="queryParams.teacherId"
          placeholder="请输入教师班级id"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['users:binding:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['users:binding:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="bindingList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="教师班级id" align="center" prop="teacherId" />
      ...
      <el-table-column label="绑定状态" align="center" prop="bStatus" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="教师班级id" prop="teacherId">
          <el-input v-model="form.teacherId" placeholder="请输入教师班级id" />
        </el-form-item>
        <el-form-item label="用户id" prop="userId">
...
<script>
import { listBinding, getBinding, delBinding, addBinding, updateBinding } from "@/api/users/binding";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listBinding(this.queryParams).then(response => {
        this.bindingList = response.rows;
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除绑定班级编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('users/binding/export', {
        ...this.queryParams
