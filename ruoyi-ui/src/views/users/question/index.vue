<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['users:question:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['users:question:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['users:question:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="questionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="问题描述" align="center" prop="qContent" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="问题描述">
          <editor v-model="form.qContent" :min-height="192"/>
        </el-form-item>
        <el-form-item label="邮箱" prop="email">
...
<script>
import { listQuestion, getQuestion, delQuestion, addQuestion, updateQuestion } from "@/api/users/question";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('users/question/export', {
        ...this.queryParams
